...
namespace OutOfOffice.Services.Migrations
{
    ...
    [Migration("20240711122232_UserEmployeeLink")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("OutOfOffice.Models.ApplicationUser", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("OutOfOffice.Models.ApplicationUser", null)
                        .WithMany()
            ...
            modelBuilder.Entity("OutOfOffice.Models.ApplicationUser", b =>
                {
                    b.HasOne("OutOfOffice.Models.Employee", "Employee")
                        ...
                        .HasForeignKey("OutOfOffice.Models.ApplicationUser", "EmployeeId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
